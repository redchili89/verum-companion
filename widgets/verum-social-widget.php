...
class VerumSocialIcons_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Verum: Social Icons', 'verum-companion' ), // Name
			array( 'description' => __( 'Social Icons', 'verum-companion' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'verum-companion' ); ?></label>
		...
		<?php foreach ( $social_icons as $sci ) {
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( $sci ) ); ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'verum-companion' ) ); ?>
					: </label>
				<br/>
